...
class Fireball(object):
    def __init__(self, x_pos, y_pos, move_directioo: bool):
        super().__init__()
        ...
        self.images.append(pg.transform.flip(pg.image.load('images/firework0.png').convert_alpha())
        self.images.append(pg.transform.flip(pg.image.load('images/firework1.png').convert_alpha())
        self.images.append(pg.transform.flip(pg.image.load('images/firework2.png').convert_alpha())
    ...
    def update_image(self, core):
        ...
        def render(self, core):
            core.screen.blit(self.images[self.current_images], core.get_map().get_camera().apply(self))
